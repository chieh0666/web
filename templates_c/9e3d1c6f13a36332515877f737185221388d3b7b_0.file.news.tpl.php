<?php
/* Smarty version 3.1.34-dev-7, created on 2020-03-11 23:40:45
  from 'E:\xampp\htdocs\web\templates\tpl\news.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5e69067d0dca04_05093362',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9e3d1c6f13a36332515877f737185221388d3b7b' => 
    array (
...
function content_5e69067d0dca04_05093362 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  <table class="table table-striped table-bordered table-hover table-sm">
    <thead class="thead-light text-center">
      <tr>
        ...
        <th scope="col">人氣</th>
        <th scope="col">
          <a href="news.php?op=op_form"><i class="fas fa-plus"></i>新增</a>
        </th>
      </tr>
    </thead>
    <tbody>
...
?>
        <tr>
          <td class="align-middle text-center"><img src="<?php echo $_smarty_tpl->tpl_vars['row']->value['news'];?>
...
" width="80px"></td>
          ...
          <td class="align-middle text-center"><?php echo $_smarty_tpl->tpl_vars['row']->value['kinds_title'];?>
</td>
          ...
          <td class="align-middle text-center">
            <a href="news.php?op=op_form&sn=<?php echo $_smarty_tpl->tpl_vars['row']->value['sn'];?>
...
if ($_smarty_tpl->tpl_vars['op']->value == "op_form") {?>
  <div class="container" style="margin: 100px auto 0px auto;">
    ...
    <form action="news.php" method="post" id="myForm" class="mb-20" enctype="multipart/form-data">
...
">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <label class="mt-1">
              <?php if ($_smarty_tpl->tpl_vars['row']->value['news']) {?>
