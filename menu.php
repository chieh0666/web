...
switch ($op){
  case "op_delete" :
    ...
    redirect_header("menu.php?kind={$kind}", $msg, 2000, "success");
    exit;
  ...
  case "op_update" :
    ...
    redirect_header("menu.php", $msg, 2000, "success");
    exit;
...
function op_insert($kind, $sn=""){
  ...
  $_POST['kind'] = db_filter($_POST['kind'], ''); //選單
  $_POST['url'] = db_filter($_POST['url'], '網址'); //網址
