      ...
      <{foreach $rows as $row}>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="<{$row.prod}>" alt="<{$row.title}>"><!-- 700*400 --></a>
            <div class="card-body">
              <h5 class="card-title">
                <a href="#"><{$row.title}></a>
              </h5>
        ...
        <tbody>
          <{if $row.sn}>
            ...
            <{foreach $orders as $sn => $order}>
              <tr>
                <td class="align-middle text-center"><img src="<{$order.prod}>" alt="<{$order.title}>" width=80></td>
                <td class="align-middle text-center"><{$order.title}></td>
                <td class="text-right align-middle price"><{$order.price}></td>
                <td class="text-center align-middle">
                  <input type="number" class="form-control amount text-right" id="amount" name="amount[<{$order.prod_sn}>]" value="<{$order.amount}>" min="0" onchange="calTotal()">
                </td>
